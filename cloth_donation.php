...
<h1 class="heading-title"> donate cloths... </h1>
<form action = "cloth_donation_form.php"  method="post" class="donation-form">
  <div class = "flex">
    <div class = "inputBox">
      <span>name: </span>
    ...
    <div class = "inputBox">
      <span>type of the cloth: </span>
      <input type = "text" placeholder="Enter the type of the cloth" name = "cloth" >
    </div>
    <div class = "inputBox">
      <span>quantity of cloths: </span>
      <input type = "number" placeholder="Enter the quantity of clothd" name = "quantity" >
    </div>
    <div class = "inputBox">
