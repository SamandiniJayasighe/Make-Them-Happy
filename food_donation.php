...
<h1 class="heading-title"> donate food... </h1>
<form action = "food_donation_form.php"  method="post" class="donation-form">
  <div class = "flex">
    <div class = "inputBox">
      <span>name: </span>
    ...
    <div class = "inputBox">
      <span>type of the food: </span>
      <input type = "radio" name = "food" value = "Non-veg food"><span>non-veg food</span>
      <input type = "radio" name = "food" value = "Veg food"><span>veg food</span>
      <input type = "radio" name = "food" value = "Both food"><span>both food</span>
    </div>
    <div class = "inputBox">
      <span>approx food: </span>
      <input type = "number" placeholder="Enter the approximate amount of food (kg)" name = "approx_food" >
    </div>
    <div class = "inputBox">
      <span>How's old food is: </span>
      <input type = "number" placeholder="Enter the approximate hours" name = "approx_hours" >
    </div>
    <div class = "inputBox">
