...
<h1 class="heading-title"> donate money... </h1>
<form action = "money_donation_form.php"  method="post" class="donation-form">
  <div class = "flex">
    <div class = "inputBox">
      <span>name: </span>
    ...
    <div class = "inputBox">
      ...
      <input type = "number" placeholder="Enter the amount of money" name = "money" >
    </div>
    <div class = "inputBox">
